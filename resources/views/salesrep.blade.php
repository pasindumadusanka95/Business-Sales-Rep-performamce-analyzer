              ...
              <div class="row">
                <div class="col-md-8  mr-auto ml-auto">
                  <div class="card">
                    ...
                    <form method="POST" action="stockupdate" enctype="multipart/form-data">
                        @csrf
                      <div class="card-body">
                        ...
                        <div class="row-sales">
                          ...
                          <input class="date form-control {{ $errors->has('dateOfSale') ? ' is-invalid' : '' }}" type="text" id="dateOfSale" name="dateOfSale" placeholder="Eg: YYYY-MM-DD" required>
                            </div>
